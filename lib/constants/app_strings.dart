...
const String InvalidAutoCompleteDialogDescription =
    'The address selected seems to have no id from Google. This is not your fault. This is Google\'s fault. Try a different address.';

const String AddressSaveFailedDialogTitle = 'Address save failed';
const String AddressSaveFailedDialogDescription = 'We were not able to save your address you have selected. Sorry for the inconvenience. Please try again.';

const String CityNotServiceDialogTitle = 'We don\t service this area';
