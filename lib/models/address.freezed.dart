...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(id: $id, placeId: $placeId, lattitude: $lattitude, longitude: $longitude, street: $street, city: $city, state: $state, postalCode: $postalCode)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, placeId, lattitude,
      longitude, street, city, state, postalCode);
