...
class AuthenticationLayout extends StatelessWidget {
  ...
  late Function? onCreateAccountSidelinerTapped;
  ...
  AuthenticationLayout({
    ...
    Function? onCreateAccountSidelinerTapped,
    ...
    this.onCreateAccountSidelinerTapped = onCreateAccountSidelinerTapped;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView(children: [
        ...
        Text(
          title,
          style: heading1Style.copyWith(fontWeight: FontWeight.w600),
        ),
        verticalSpaceSmall,
        SizedBox(
        ...
        if (onForgetPasswordTapped != null)
          Align(
            ...
            child: GestureDetector(
              ...
              child: Text(
                'Forgot Password',
                style: ktsMediumGreyBodyText.copyWith(fontWeight: FontWeight.w600),
              ),
            ),
          ),
        verticalSpaceRegular,
        if (validationMessage != null) Text(validationMessage!, style: TextStyle(color: Colors.red, fontSize: 16)),
